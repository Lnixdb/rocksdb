...
IOStatus ZondaFileSystem::NewSequentialFile(const std::string& fname,
                           ...
                           IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("new_sequential").Increment();
...
IOStatus ZondaFileSystem::NewRandomAccessFile(const std::string& fname,
  ...
  ZondaFSMetrics::Instance().Method("random_access").Increment();
...
IOStatus ZondaFileSystem::NewWritableFile(const std::string& fname,
                          ...
                          IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("writable_file").Increment();
...
IOStatus ZondaFileSystem::ReopenWritableFile(const std::string& fname,
                            ...
                            std::unique_ptr<FSWritableFile>* result,
                            IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("reopen_file").Increment();
...
IOStatus ZondaFileSystem::ReuseWritableFile(const std::string& fname,
                           ...
                           std::unique_ptr<FSWritableFile>* result,
                           IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("reuse_file").Increment();
...
IOStatus ZondaFileSystem::NewRandomRWFile(const std::string& fname,
                          ...
                          IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("random_rw").Increment();
...
IOStatus ZondaFileSystem::NewMemoryMappedFileBuffer(
  ...
  ZondaFSMetrics::Instance().Method("mapped_file").Increment();
...
IOStatus ZondaFileSystem::NewDirectory(const std::string& name,
                      ...
                      IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("new_directory").Increment();
...
IOStatus ZondaFileSystem::FileExists(const std::string& fname,
                    const IOOptions& opts,
                    IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("file_exists").Increment();
...
IOStatus ZondaFileSystem::GetChildren(const std::string& dir,
                     ...
                     IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("get_children").Increment();
...
IOStatus ZondaFileSystem::DeleteFile(const std::string& fname,
                    const IOOptions& opts,
                    IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("delete_file").Increment();
...
IOStatus ZondaFileSystem::CreateDir(const std::string& name,
                  const IOOptions& opts,
                  IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("create_dir").Increment();
...
IOStatus ZondaFileSystem::CreateDirIfMissing(const std::string& name,
                            const IOOptions& opts,
                            IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("create_dir_if_missing").Increment();
...
IOStatus ZondaFileSystem::DeleteDir(const std::string& name,
                  const IOOptions& opts,
                  IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("delete_dir").Increment();
...
IOStatus ZondaFileSystem::GetFileSize(const std::string& fname,
  ...
  ZondaFSMetrics::Instance().Method("get_file_size").Increment();
...
IOStatus ZondaFileSystem::GetFileModificationTime(const std::string& fname,
                                 ...
                                 uint64_t* file_mtime,
                                 IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("modification_time").Increment();
...
IOStatus ZondaFileSystem::RenameFile(const std::string& src,
                    ...
                    const IOOptions& opts,
                    IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("rename_file").Increment();
...
IOStatus ZondaFileSystem::LinkFile(const std::string& src,
                  ...
                  const IOOptions& opts,
                  IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("link_file").Increment();
...
IOStatus ZondaFileSystem::NumFileLinks(const std::string& fname,
  ...
  ZondaFSMetrics::Instance().Method("num_link_file").Increment();
...
IOStatus ZondaFileSystem::AreFilesSame(const std::string& first,
                      ...
                      IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("are_file_same").Increment();
...
IOStatus ZondaFileSystem::GetAbsolutePath(const std::string& db_path,
                         ...
                         IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("get_absolute_path").Increment();
...
IOStatus ZondaFileSystem::GetTestDirectory(const IOOptions& opts,
                          std::string* result,
                          IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("get_test_directory").Increment();
...
IOStatus ZondaFileSystem::GetFreeSpace(const std::string& fname,
                      ...
                      uint64_t* free_space,
                      IODebugContext* dbg)  {
  ZondaFSMetrics::Instance().Method("get_free_space").Increment();
...
IOStatus ZondaFileSystem::IsDirectory(const std::string& path,
  ...
  ZondaFSMetrics::Instance().Method("is_directory").Increment();
...
FileOptions ZondaFileSystem::OptimizeForLogWrite(const FileOptions& file_options,
  ...
  ZondaFSMetrics::Instance().Method("optimize_for_log_write").Increment();
...
FileOptions ZondaFileSystem::OptimizeForManifestWrite(
  ...
  ZondaFSMetrics::Instance().Method("optimize_for_manifest").Increment();
...
FileOptions ZondaFileSystem::OptimizeForCompactionTableRead(
  ...
  ZondaFSMetrics::Instance().Method("optimize_for_compaction").Increment();
